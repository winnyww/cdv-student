...
d3.csv('by-country.csv').then(function(incomingData){
  ...
  const center2018 = { x: w/10*2, y: h/2-50};
  const center2019 = { x: w/10*4, y: h/2-50};
  const center2020 = { x: w/10*6, y: h/2-50};
  const center2021 = { x: w/10*8, y: h/2-50};
  ...
  bubbles2018.append('text').text(getText);
